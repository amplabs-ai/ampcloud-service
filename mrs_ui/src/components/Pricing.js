    ...
    return (
        <>
            ...
            <div style={{ marginTop: "75px", paddingBottom: "100px" }}>
                ...
                <Row justify='center'>
                    <Col span={10} >
                        <p className='fw-light bg-light p-4 fs-5' style={{ lineHeight: '2rem' }}>At AmpLabs, we're committed to providing value for the <b>Battery Professionals Community</b>. We will always provide <b>Community features for free to all</b>. Consider <b>subscribing to Pro tier</b> to help bring Battery Data tools to the world. For people with custom requirements <b>please reach out to us</b> and we can figure out a solution that works best for you.</p>
                    </Col>
                </Row>
                <Row justify="center">
                    <Col span={10}  >
            ...
            <Footer style={{ textAlign: 'center' }} className="bg-dark text-white">Find a bug, request a feature, or desire a change, please report any requests to <a href="mailto:ask@amplabs.ai">ask@amplabs.ai</a></Footer>
        </>
    )
}

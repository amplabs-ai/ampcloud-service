				...
				<Row>
					<Col span={10} offset={7}>
						<p className="fw-light bg-light p-4 fs-5" style={{ lineHeight: "2rem" }}>
							At AmpLabs we're committed to providing value for the <b>Clean Energy community</b>. We will always
							provide Community features for free to all. Consider subscribing to <b>Analyst tier</b> to help bring
							Battery Data tools to the world. For people with custom requirements please <b>reach out to us</b> and we
							can figure out a solution that works best for you.
						</p>
					</Col>
				</Row>
				<Row>
						...
						<Col justify="center">
							...
							<div className="site-card-wrapper mt-2" style={{ display: "flex", position: "absolute" }}>
								<Row gutter={40}>
									<Col span={8}>
										<Card style={{ width: 220 }} className="shadow">
											...
											<Button
												type="primary"
												onClick={() => {
													window.location.href = "/dashboard?plan=community";
												}}
												ghost
												style={{
													borderRadius: "4px",
									...
									<Col span={8}>
										<Card
											style={{ backgroundImage: `url(${background})`, backgroundSize: "cover", width: 220 }}

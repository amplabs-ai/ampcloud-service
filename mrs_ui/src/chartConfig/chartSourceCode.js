...
def get_amplabs_chartdata(req_data):
    url = "https://www.amplabs.ai/echarts/forceDisplacement"
...
def plot_chart(df):
    fig = px.line(df, x="test_time", y="value", color="series", labels={"test_time":"Time (s)", "value":"Force (N) / Displacement"}, title = "Force and Displacement")
    fig.update_traces(mode="markers+lines", hovertemplate=None)
    fig.update_layout(hovermode="x")
...
def get_amplabs_chartdata(req_data):
    url = "https://www.amplabs.ai/echarts/testTemperature"
    payload = json.dumps(req_data)
    headers = {
    'Authorization': 'Bearer __accesstoken__',
    'Content-Type': 'application/json'
...
def get_amplabs_chartdata(req_data):
    url = "https://www.amplabs.ai/echarts/testVoltage"
    payload = json.dumps(req_data)
    headers = {
    'Authorization': 'Bearer __accesstoken__',
    'Content-Type': 'application/json'
...
def plot_chart(df):
    fig = px.line(df, x="test_time", y="value", color="series", labels={"test_time":"Time (s)", "value":"Voltage (V)"}, title = "Voltage - Abuse Voltage")
    fig.update_traces(mode="lines", hovertemplate=None)
    fig.update_layout(hovermode="x")
...
def get_amplabs_chartdata(req_data):
    url = "https://www.amplabs.ai__endpoint__"
    payload = json.dumps(req_data)
    headers = {
    'Authorization': 'Bearer __accesstoken__',
    'Content-Type': 'application/json'
...
def plot_chart(df):
    fig = px.line(df, x="cycle_index", y="value",color="series", labels={"cycle_index":"Cycle Index", "value":"Energy Density"}, title = "Energy Density VS Cycle Index")
    fig.update_traces(mode="lines", hovertemplate=None)
    fig.update_layout(hovermode="x")
...
def plot_chart(df):
    fig = px.line(df, x="cycle_index", y="value", color="series", labels={"cycle_index":"Cycle Index", "value":"Specific Capacity"}, title = "Specific Capacity vs Cycle Index")
    fig.update_traces(mode="markers+lines", hovertemplate=None)
    fig.update_layout(hovermode="x")
    pio.write_image(fig, file='./capacity.png', format="png", scale=1, width=1200, height=800)
...
def plot_chart(df):
    fig = px.line(df,x="cycle_index" ,y="value",color="series",labels={"cycle_index":"Cycle Index", "value":"Operating Potential"}, title = "Operating Potential VS Cycle Index")
    fig.update_traces(mode="markers+lines", hovertemplate=None)
    fig.update_layout(hovermode="x")
    pio.write_image(fig, file='./operatingPotential.png', format="png", scale=1, width=1200, height=800)
